...
from config import GITHUB, ICON_SRC
                                    ...
                                    c.Div(
                                        ...
                                        components=[
                                            c.Link(
                                                ...
                                                active=True,
                                                components=[
                                                    c.Image(src=ICON_SRC, width="155%")
                                                ],
                                            ),
                                            c.Link(
                                                ...
                                                active=True,
                                                components=[
                                                    c.Heading(text="Pastebin", level=2)
                                                ],
                                            ),
                                        ],
                                    )
                        ...
                        form_fields=[
                            ...
                            c.forms.FormFieldSelect(
                                ...
                                options=[
                                    ...
                                    SelectOption(
                                        value=expiration.ten_minutes, label="10 Minutes"
                                    ),
                                    ...
                                    SelectOption(
                                        value=expiration.two_weeks, label="2 Weeks"
                                    ),
                                    SelectOption(
                                        value=expiration.month, label="1 Month"
                                    ),
                                    SelectOption(
                                        value=expiration.half_year, label="Half-year"
                                    ),
        ...
        components=[
            c.Div(
                ...
                components=[
                    c.Div(
                        class_name="col-8",
                        components=[c.Code(class_name="form-control", text=text)],
                    )
                ],
            )
        ],
